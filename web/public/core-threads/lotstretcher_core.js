/* @ts-self-types="./lotstretcher_core.d.ts" */
 ...
 * @param {string} op
 * @param {Uint8Array} arena
 * @returns {any}
 */
export function call(op, arena) {
    const ptr0 = passStringToWasm0(op, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len0 = WASM_VECTOR_LEN;
    const ptr1 = passArray8ToWasm0(arena, wasm.__wbindgen_malloc);
 ...
 * @returns {Uint8Array}
 */
export function compose_hero(request, arena) {
    const ptr0 = passStringToWasm0(request, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len0 = WASM_VECTOR_LEN;
    const ptr1 = passArray8ToWasm0(arena, wasm.__wbindgen_malloc);
    const len1 = WASM_VECTOR_LEN;
    const ret = wasm.compose_hero(ptr0, len0, ptr1, len1);
    if (ret[3]) {
 ...
 * @param {Uint8Array} border
 * @param {number} width
 * @param {number} height
 * @returns {Int32Array}
 */
export function detect_window(border, width, height) {
    const ptr0 = passArray8ToWasm0(border, wasm.__wbindgen_malloc);
    const len0 = WASM_VECTOR_LEN;
    const ret = wasm.detect_window(ptr0, len0, width, height);
    if (ret[3]) {
        throw takeFromExternrefTable0(ret[2]);
    }
 ...
 * @param {string | null | undefined} exterior
 * @param {string | null | undefined} interior
 * @param {Uint8Array} sample
 * @param {number} width
 * @param {number} height
 * @returns {Uint8Array}
 */
export function vehicle_gradient_colors(exterior, interior, sample, width, height) {
    var ptr0 = isLikeNone(exterior) ? 0 : passStringToWasm0(exterior, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    var len0 = WASM_VECTOR_LEN;
    var ptr1 = isLikeNone(interior) ? 0 : passStringToWasm0(interior, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    var len1 = WASM_VECTOR_LEN;
    const ptr2 = passArray8ToWasm0(sample, wasm.__wbindgen_malloc);
    const len2 = WASM_VECTOR_LEN;
    const ret = wasm.vehicle_gradient_colors(ptr0, len0, ptr1, len1, ptr2, len2, width, height);
...
function __wbg_get_imports(memory) {
    ...
    return {
        __proto__: null,
        "./lotstretcher_core_bg.js": import0,
    };
}
...
async function __wbg_init(module_or_path, memory) {
    ...
    if (module_or_path === undefined) {
        module_or_path = new URL('lotstretcher_core_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports(memory);
